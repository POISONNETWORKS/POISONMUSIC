...
from POISONMUSIC.utils.inline import aq_markup, close_markup, stream_markup
from POISONMUSIC.utils.pastebin import POISONBIN
from POISONMUSIC.utils.stream.queue import put_queue, put_queue_index
from POISONMUSIC.utils.thumbnails import get_thumb
from POISONMUSIC.utils.errors import capture_internal_err
...
async def stream(
    ...
    if not result:
        return
    if forceplay:
        await POISON.force_stop_stream(chat_id)
